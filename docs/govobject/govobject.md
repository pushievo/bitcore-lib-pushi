...
var jsonProposal = {
  ...
  url:"http://www.pushiplay.pw/proposal/first_proposal"
};
...
```javascript
proposal.url="http://pushiplay.pw/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://pushiplay.pw/fixedUrl"
